Shader "Hidden/Locked/.poiyomi/Old Versions/9.0/Poiyomi Toon/7c8a2ace9525c764687a82ca4e33c1a4"
{
	Properties
	{
 ...
 #define OPTIMIZER_ENABLED 
			...
			void ApplyGlobalMaskModifiers(in PoiMesh poiMesh, inout PoiMods poiMods, in PoiCam poiCam)
			{
				...
				{
					handleGlobalMaskDistance(0, (1 /*_GlobalMaskDistanceEnable_0*/), (0 /*_GlobalMaskDistanceType_0*/), (1.0 /*_GlobalMaskDistanceMinAlpha_0*/), (0.0 /*_GlobalMaskDistanceMaxAlpha_0*/), (4.0 /*_GlobalMaskDistanceMin_0*/), (6.0 /*_GlobalMaskDistanceMax_0*/), (2 /*_GlobalMaskDistanceBlendType_0*/), poiMesh, poiMods);
				}
			}
			#ifdef POI_UDIMDISCARD
 ...
 #define OPTIMIZER_ENABLED 
			...
			void applyDecals(inout PoiFragData poiFragData, in PoiMesh poiMesh, in PoiCam poiCam, inout PoiMods poiMods, in PoiLight poiLight)
			{
				...
				Decal0.m_DecalApplyGlobalMaskIndex = (1.0 /*_Decal0ApplyGlobalMaskIndex*/);
				Decal0.m_DecalApplyGlobalMaskBlendType = (1.0 /*_Decal0ApplyGlobalMaskBlendType*/);
				...
				Decal1.m_DecalApplyGlobalMaskIndex = (1.0 /*_Decal1ApplyGlobalMaskIndex*/);
				Decal1.m_DecalApplyGlobalMaskBlendType = (1.0 /*_Decal1ApplyGlobalMaskBlendType*/);
			...
			void applyDissolve(inout PoiFragData poiFragData, in PoiMesh poiMesh, inout PoiMods poiMods, in PoiCam poiCam, in PoiLight poiLight)
			{
				...
				if ((1.0 /*_DissolveMaskGlobalMask*/) > 0)
				{
					dissolveMask = maskBlend(dissolveMask, poiMods.globalMask[(1.0 /*_DissolveMaskGlobalMask*/) - 1], (2.0 /*_DissolveMaskGlobalMaskBlendType*/));
				}
				#if defined(PROP_DISSOLVETOTEXTURE) || !defined(OPTIMIZER_ENABLED)
				...
				#endif
				#if defined(PROP_DISSOLVENOISETEXTURE) || !defined(OPTIMIZER_ENABLED)
				float dissolveNoiseTexture = POI2D_SAMPLER_PAN(_DissolveNoiseTexture, _MainTex, poiUV(poiMesh.uv[(1.0 /*_DissolveNoiseTextureUV*/)], float4(0.5,0.5,0,0)), float4(0,0,0,0)).r;
				#else
				float dissolveNoiseTexture = 1;
				#endif
				float da = (0.01 /*_DissolveAlpha*/)
				+ (0.0 /*_DissolveAlpha0*/)
				+ (0.0 /*_DissolveAlpha1*/)
				+ (0.0 /*_DissolveAlpha2*/)
				+ (0.0 /*_DissolveAlpha3*/)
				...
				#if defined(PROP_DISSOLVEDETAILNOISE) || !defined(OPTIMIZER_ENABLED)
				float dissolveDetailNoise = POI2D_SAMPLER_PAN(_DissolveDetailNoise, _MainTex, poiUV(poiMesh.uv[(1.0 /*_DissolveDetailNoiseUV*/)], float4(1,1,0,0)), float4(7.5,0,0,0));
				#else
				...
				switch((1.0 /*_DissolveType*/))
				{
					default: // Basic (case 1)
					{
						...
						dissolveAlpha = da;
						dds *= smoothstep(1, 0.99, da) * lerp(1, smoothstep(0, lerp(0.01, 0.1, dds), da), (0.886 /*_DissolveDetailEdgeSmoothing*/));
					...
					case 3: // Spherical
					{
						...
						dissolveAlpha = da;
						dds *= smoothstep(0, 0.2 * dds + 0.01, dissolveAlpha) * lerp(1, smoothstep(1, 1 - 0.2 * dds - 0.01, dissolveAlpha), (0.886 /*_DissolveDetailEdgeSmoothing*/));
				...
				if ((1.0 /*_DissolveInverseApplyGlobalMaskIndex*/) > 0)
				{
					applyToGlobalMask(poiMods, (1.0 /*_DissolveInverseApplyGlobalMaskIndex*/) - 1, (2.0 /*_DissolveInverseApplyGlobalMaskBlendType*/), 1 - (dissolveAlpha * .999999));
				}
			...
			void ApplyAudioLinkVolumeColor(in PoiMesh poiMesh, inout PoiFragData poiFragData, in PoiMods poiMods)
			{
				...
				float3 lowColor = float4(0,1,0,1).rgb * poiThemeColor(poiMods, float4(0,1,0,1).rgb, (0.0 /*_ALVolumeColorLowThemeIndex*/));
				float3 midColor = float4(0.9290769,1,0,1).rgb * poiThemeColor(poiMods, float4(0.9290769,1,0,1).rgb, (0.0 /*_ALVolumeColorMidThemeIndex*/));
				...
				float3 emissionColor = lerp(lowColor * (1.0 /*_ALLowEmission*/), midColor * (1.0 /*_ALMidEmission*/), saturate(volume * 2));
				emissionColor = lerp(emissionColor, highColor * (1.0 /*_ALHighEmission*/), saturate(volume * 2 - 1));
			...
			float3 applyEmission(inout PoiFragData poiFragData, in PoiMesh poiMesh, in PoiLight poiLight, in PoiCam poiCam, in PoiMods poiMods)
			{
				...
				#if defined(PROP_EMISSIONMASK) || !defined(OPTIMIZER_ENABLED)
				float emissionMask0 = UNITY_SAMPLE_TEX2D_SAMPLER(_EmissionMask, _MainTex, poiUV(poiMesh.uv[(1.0 /*_EmissionMaskUV*/)], float4(1,1,0,0)) + _Time.x * float4(0,0,0,0))[(0.0 /*_EmissionMaskChannel*/)];
				#else
			...
			float4 frag(VertexOut i, uint facing : SV_IsFrontFace) : SV_Target
			{
				...
				#ifdef _RIMSTYLE_POIYOMI
				#if defined(PROP_RIMMASK) || !defined(OPTIMIZER_ENABLED)
				float4 rimMaskAndBias = POI2D_SAMPLER_PAN(_RimMask, _MainTex, poiUV(poiMesh.uv[(1.0 /*_RimMaskUV*/)], float4(1,1,0,0)), float4(0,0,0,0));
